...
router.post('/file-upload',[authAdminMiddleware,authMiddleware],createCandidatesFromFileUpload)
...
router.delete('/:id',[authMiddleware,authAdminMiddleware],deleteCandidateGroup)
